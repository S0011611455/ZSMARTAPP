		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Smart App Tutorial",
									"targetURL": "#comwakefernzsmartapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comwakefernzsmartapp-display": {
								"semanticObject": "comwakefernzsmartapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.wakefern.zsmartapp",
									"url": sap.ui.require.toUrl("com/wakefern/zsmartapp")
								}
							}
						}
					}
